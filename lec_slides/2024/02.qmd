...
![](ImpactEvaluation/figure/fig2_ek_19_improved_educational_outcomes.jpg)
...
* 検討手段が実験可能なものに集中: 薬、職業訓練、教材、補助教員、肥料、携帯
	...
	* 倫理的に許要できる: 母乳育児、違法行為(贈賄: インド)推奨は駄目、政治デモ参加推奨(して参加人数計測)は文脈による\citep{Bursztyn2021}?
...
![鍵を捜す男](ImpactEvaluation/figure/FindKey.jpg){height = 7cm}
...
::: {.column width="60%"}
![](ImpactEvaluation/figure/bad_graphs/hahaha0.eps){height = 7cm}
:::

::: {.column width="40%"}

![](ImpactEvaluation/figure/bad_graphs/hahaha1.eps){}}
...
笑いは健康(自己申告)を引き起こすか?
* 可能性はある%Maybe. 
* もしくは、健康が笑いを引き起こす%Or healthiness can cause laugher.
* もしくは、その両方%Or both.
...
![](ImpactEvaluation/figure/bad_graphs/hahaha.eps){height = 8cm}
