...
![](../CommonFiles/ImpactEvaluation/figure/BanerjeeDufloKremer.jpg)
...
![](../CommonFiles/ImpactEvaluation/figure/fig2_ek_19_improved_educational_outcomes.jpg){width=14cm}
...
::: {.column width="60%"}
![鍵を捜す男](../CommonFiles/ImpactEvaluation/figure/FindKey_small.jpg){.lightbox height=50%}  
:::
::: {.column width="30%"}
...
::: {.column width="60%"}
![](../CommonFiles/ImpactEvaluation/figure/hahaha0.jpg){width=25cm}
:::

::: {.column width="40%"}

![](../CommonFiles/ImpactEvaluation/figure/hahaha1.jpg){}
...
![](../CommonFiles/ImpactEvaluation/figure/hahaha.jpg){height=800}
...
::: {.column width="50%"}
![](../CommonFiles/ImpactEvaluation/figure/FMR_Fig4.jpg){height="60%"}
:::
...
::: {.column width=75%}
![](../CommonFiles/ImpactEvaluation/figure/bad_graphs/subaru02.jpg)
:::
...
::: {.column width=65%}
![](../CommonFiles/ImpactEvaluation/figure/bad_graphs/subaru01.jpg){}
:::
...
knitr::include_graphics("../CommonFiles/2/Nikkei2024Oct21.jpg")
```
knitr::include_graphics gives wierd scroll bar. For ![](){}, height="50%" does not work, only width does.
-->

![日経新聞10月21日(月)朝刊](../CommonFiles/2/Nikkei2024Oct21.jpg){width="60%"}
:::
...
::: {.column width=65%}
![](../CommonFiles/ImpactEvaluation/figure/maimonides-mishna.jpg){width="90%"}
:::

::: {.column width=25%}
::: {.fragment}
![](../CommonFiles/ImpactEvaluation/figure/maimonides.jpg){}
:::
:::
...
::: {.column width=25%}
:::{.fragment}
![](../CommonFiles/ImpactEvaluation/figure/AEvans_Fig01.jpg){width="90%"}
```{r , eval = F, echo = F, out.width='70%'}
knitr::include_graphics("../CommonFiles/ImpactEvaluation/figure/AEvans_Fig01.jpg")
```
:::
:::
...
::: {.column width=25%}
:::{.fragment}
![](../CommonFiles/ImpactEvaluation/figure/AEvans_Fig02.jpg){width="90%"}
```{r , eval = F, echo = F, out.width='70%'}
knitr::include_graphics("../CommonFiles/ImpactEvaluation/figure/AEvans_Fig02.jpg")
```
:::
:::
...
::::{.columns}
::: {.column width=30%}
![4th graders](../CommonFiles/ImpactEvaluation/figure/AEvans_Tab05.jpg){width="99%"}
:::
...
![4th graders](../CommonFiles/ImpactEvaluation/figure/AEvans_Tab05.jpg){}
...
::::{.columns}
::: {.column width=99%}
![4th and 5th graders, discontinuity samples](../CommonFiles/ImpactEvaluation/figure/ALavy_Tab06.jpg){width="70%"}
:::
::::
...
![](../CommonFiles/ImpactEvaluation/figure/Akabayashi_ClassSizeYokohamaShou6.png)
...
![](../CommonFiles/ImpactEvaluation/figure/Akabayashi_ClassSizeYokohamaChu3.png)
...
::::{.columns}
::: {.column width=60%}
![ダイアモンド・オンライン2015年2月18日<https://diamond.jp/articles/-/66992>](../CommonFiles/ImpactEvaluation/figure/35ninGakkyu_DiamondOnline.jpg){width="80%"}  
:::
...
::::{.columns}
::: {.column width=40%}
![日経新聞2020年12月17日(木)朝刊](../CommonFiles/ImpactEvaluation/figure/Nikkei_35NinClass2020Dec17.jpg){width="80%"}
:::
...
::::{.columns}
::: {.column width=60%}
![](../CommonFiles/ImpactEvaluation/figure/Lemieux_Fig03.jpg)
:::
...
::::{.columns}
::: {.column width=60%}
![](../CommonFiles/ImpactEvaluation/figure/Lee_Fig02a.jpg){}
:::
...
::::{.columns}
::: {.column width=50%}
![](../CommonFiles/ImpactEvaluation/figure/Lemieux_Tab03.jpg)

Rest of Canada or post 1991 should not detect effects.
:::

::: {.column width=50%}
![](../CommonFiles/ImpactEvaluation/figure/Lee_Fig02b.jpg)
...
![Figure 2, @BoschSchady2019](../CommonFiles/ImpactEvaluation/figure/BoschSchady_DensityTest.jpg)
...
::::::::: {.columns}
::: {.column width="50%"}
![FNNプライムニュース2020年11月25日(水)](../CommonFiles/ImpactEvaluation/figure/Suga_NoEvidenceCropped.jpg)
:::
...
:::{.column width="50%"}
![論文: @Miyawaki2020](../CommonFiles/ImpactEvaluation/figure/TokyoShinbun_GoToCovid.jpg)
:::
...
:::::::::: {.columns}
::::{.column width="50%"}
![厚生労働省感染症アドバイザリーボード2020年11月19日(木)資料3(参考資料)](../CommonFiles/ImpactEvaluation/KoroAdbBoardMaterial3_2020Nov19.jpg)
::::
...
:::::::::: {.columns}
::::{.column width="50%"}
![](../CommonFiles/ImpactEvaluation/figure/ImpactsDropTiesWithTokyo.jpg)

![](../CommonFiles/ImpactEvaluation/figure/SmokePlotsDropTiesWithTokyo.jpg)
::::
...
:::::::::: {.columns}
::::{.column width="50%"}
![リッジ密度図](../CommonFiles/ImpactEvaluation/figure/SmokeDensityDropTiesWithTokyo.jpg)
::::
...
![](../CommonFiles/ImpactEvaluation/figure/spain-states-map.jpg)
...
1. 計<span style="color:white;background-color:pink;">$J$</span>郡$(j=1,\dots,J)$について結果変数(成長)に影響する<span style="color:white;background-color:pink;">$I$</span>個の共変数predictors $x_{1jt}, \cdot, x_{Ijt}$をテロ前の時期<span style="color:white;background-color:pink;">$t=1, \dots ,T$</span>について集める。結果変数を全期間<span style="color:white;background-color:pink;">$t=1, \dots , T$</span><span style="color:white;background-color:blue;">$, T+1, T+2, \dots, T+L$</span>について集める。<gray>Pick variables correlated with growth (=growth predictors) in Basque. Form a vector $\bfx_{Bt}$ for all pre-terrorism periods $t=1,\cdots, T$. Do the same for other $J$ counties and form a matrix $\bfX_{t}=\left(\begin{array}{ccc} \bfx_{1t} & \cdots & \bfx_{Jt}\end{array}\right)$.</gray>
1. テロ前<span style="color:white;background-color:pink;">$T$</span>期間データ(結果変数と共変数)を使い、バスクとバスク以外の加重平均の差の2乗和を最小化する各変数(結果変数と共変数)$z_{ibt}$共通の郡ウェイト$w^{*}_{1}, \dots, w^{*}_{J}$を選ぶ。<gray>Minimise normalised sum of square differences $\sum_{t=1}^{T}(\bfx_{Bt}-\bfX_{t}\bfw)'\bfV^{-1}(\bfx_{Bt}-\bfX_{t}\bfw)$ by choosing weighting vector $\bfw$ optimally. Denote the optimal weight as $\bfw^{*}$.</gray>


----

事前<span style="color:white;background-color:pink;">$I$</span>個×<span style="color:white;background-color:pink;">$J$</span>主体×<span style="color:white;background-color:pink;">$T$</span>期間, 事後<span style="color:white;background-color:blue;">$1$</span>個×<span style="color:white;background-color:blue;">$J$</span>主体×<span style="color:white;background-color:blue;">$L$</span>期間

* バスクの$t$期の$i$変数$x_{iBt}$の誤差$e_{it}=x_{iBt}-\sum\limits_{j=1}^{J}w_{j}x_{ijt}$
   * バスクの$t$期の$i$変数$x_{iBt}$-その他地域$j(=1,\dots, J)$の$t$期の$i$変数$x_{iBt}$の加重平均値weighted mean
   * $w_{j}$は$j$地域の加重weight, $w_{j}\in[0, 1]$、$\sum\limits_{j=1}^{J}w_{j}=1$
* バスクの$i$変数$x_{iB}$の誤差2乗和$sse_{i}=\sum\limits_{t=1}^{T}e^{2}_{it}$
* バスクの$I$個の変数ベクトル$x_{1Bt}, \dots, x_{IBt}$の誤差2乗和$sse=\sum\limits_{i=1}^{I}\frac{sse_{i}}{I}$

. . .

誤差2乗和$sse$を最小化するように$J$個の$w_{j}$を選ぶ&larr;数学の最小化問題、簡単です

----

* $I=1$は結果変数(=感染者数)のみを使うとき
* $I=1$でも良いが、たいていは複数の変数(共変数covariates)を使って$w_{j}$を計算
   * 共変数: 人口密度、投資率、各産業シェア、識字率その他学歴人口比率&larr;GDPに影響する変数

* 2乗和関数$\sum\limits_{i=1}^{I}\sum\limits_{t=1}^{T}\left(x_{iBt}-\sum\limits_{j=1}^{J}w_{j}x_{ijt}\right)^{2}=\sum\limits_{i=1}^{I}\sum\limits_{t=1}^{T}e^{2}_{it}$に最小化の一階条件を使う
* $\sum\limits_{j=1}^{J}\hat{w}_{j}y_{jT+1}=\hat{y}_{T+1}, \sum\limits_{j=1}^{J}\hat{w}_{j}y_{jT+2}=\hat{y}_{T+2}, \cdots$がテロ以降のテロ無し合成バスク。

. . .

結果変数と共変数という観察可能な変数を使ってCFを作っている

* 観察可能な変数が似ていればcontrol &rarr; 観察可能な変数が似ていればtreated/controlの割り当てはランダムと想定

. . .

観察可能な変数$\bfx_{i}$で自己選抜が説明可能: **selection on the observable** $y_{i}\perp D_{i}|\bfx_{i}$

----

![Terrorism impacts on growth: T=1969](../CommonFiles/ImpactEvaluation/figure/Abadie_Fig01.jpg)

----

![A placebo study: Catalonia: バスクに似ているがテロがない](../CommonFiles/ImpactEvaluation/figure/Abadie_Fig04.jpg)
...
観察可能な変数による選抜の意味<gray>what we mean by selection on the observable</gray>
...
「テロが起こるとすればバスクしかなかったが、共変数$\bfx$を考慮すれば、テロの原因と成長とは関係がない」
...
::::::::::: {.columns}
:::: {.column width="50%"}
![Tobacco tax in California and per capita cigarette sales](../CommonFiles/ImpactEvaluation/figure/abadie_tobacco_main.jpg)
::::

:::: {.column width="50%"}
::: {.fragment}
![Tobacco tax in California, placebo studies on all control states, lines show gap = actual - synthetic contro](../CommonFiles/ImpactEvaluation/figure/abadie_tobacco_placebo.jpg)
:::
:::: 
:::::::::::
...
![Mafia violence on growth in Apulia and Basilicata](../CommonFiles/ImpactEvaluation/figure/Pinotti_mafia_Fig06.jpg)

----

@Pinotti2015 on effects of mafia violence on growth

![Apulia and Basilicata were new to violence](../CommonFiles/ImpactEvaluation/figure/Pinotti_mafia_Fig04.jpg)

----

@Pinotti2015 on effects of mafia violence on growth

![Mafia violence deters investments](../CommonFiles/ImpactEvaluation/figure/Pinotti_mafia_Fig09.jpg)

----

@Pinotti2015 on effects of mafia violence on growth

![Mafia violence slows industry (\% of provincial GDP)](../CommonFiles/ImpactEvaluation/figure/Pinotti_mafia_Fig12.jpg)

----

@Pinotti2015 on effects of mafia violence on growth

![Mafia violence placebo studies](../CommonFiles/ImpactEvaluation/figure/Pinotti_mafia_Fig10.jpg)
...
![Private and public investment and employment](../CommonFiles/ImpactEvaluation/figure/Pinotti_mafia_Fig13.jpg)

----

@Billmeier2013 on the effects of trade liberalisation on growth

![貿易自由化の効果、Asia](../CommonFiles/ImpactEvaluation/figure/Billmeier_Fig01.jpg)

----

@Billmeier2013 on the effects of trade liberalisation on growth

![Latin America](../CommonFiles/ImpactEvaluation/figure/Billmeier_Fig02.jpg)

----

@Billmeier2013 on the effects of trade liberalisation on growth

![Africa before 1987](../CommonFiles/ImpactEvaluation/figure/Billmeier_Fig03.jpg)

----

@Billmeier2013 on the effects of trade liberalisation on growth

![Africa 1987-91](../CommonFiles/ImpactEvaluation/figure/Billmeier_Fig04.jpg)

----

@Billmeier2013 on the effects of trade liberalisation on growth

![Africa after 1991](../CommonFiles/ImpactEvaluation/figure/Billmeier_Fig05.jpg)

----

@Billmeier2013 on the effects of trade liberalisation on growth

怪しい結果に思える<gray>questionable results</gray>

* 貿易自由化していないdonor poolを使って加重平均を合成<gray>uses a donor pool that has not gone through trade liberalisation to construct a weighted mean</gray>
* 共変数: 中等就学率、人口増加率、投資/GDP、インフレ率、民主主義インデックス<gray>covariates: secondary school enrollment rates, population groth rates, investmet rates, inflation rates, democracy index</gray>
* 共変数が似ていて(貿易自由化していなくて)も、成長率は人口規模、天然資源、気候変動、紛争などによっても影響される<gray>even when covariates are similar, growth can be affected by population size, natural resource endowment, climate change, conflicts</gray>

. . .

どこまで共変数として含めれば良いのか、誰も説得的な議論はできない<gray>no convincing argument has been made for what variables should be used as covariates</gray>

. . .

しかし、叙述的研究はそういうことをやっている<gray>but descriptive research does these things, too</gray>

* 選定基準を明確化して数値化しているだけまし<gray>better if we make selection criteria explicit and numerical</gray>
...
::::::::::: {.columns}
:::: {.column width="50%"}
![](../CommonFiles/ImpactEvaluation/figure/MVPhase1Evaluation.jpg)
::::
...
::::::::::: {.columns}
:::: {.column width="70%"}
![@ClemensDemombynes2011, Figure 10](../CommonFiles/ImpactEvaluation/figure/ClemensDemombynes2010_MilleniumVillageEvaluation_Fig10.jpg){width="85%"}
::::
...
1. 村は常に変化しているから、村レヴェルでの実験に統御群は作れない<gray>With communities, there are no true controls. Life changes everywhere, in the MVs and outside of them.</gray>
    * 村が常に変化しているからこそ、実際の村が統御群として必要
1. 介入は村が自ら学んで改善するという過程を経る。この過程はRCTで評価できない。<gray>The logic of simple randomized trials does not apply in a context of design with extensive learning by doing, where the main goal is to develop new tools and systems that are replicable and scalable and used by the community itself</gray>
...
::: {style="font-size: 60%;line-height: 1.1;"}
<gray>There has been much naïve talk about paired “comparison” villages...(snip)... in year 1 the considerable work required to create a foundation of community-driven strategies in the context of a very complex project took precedent...(snip)...Spending a great deal of time and personnel on one particular “comparison site” is misplaced concreteness. ..(snip)...The comparison village is definitely not a “control” village in the sense of a real, unchanged control, nor could it be…No place is standing still to be a control site … If the comparison site happens to get a new road or an extension of the power grid, this gives an artificial “small sample” error to the comparison with the MV.</gray>
:::
...
:::: {.column width="30%"}
![@Mitchell2018, Figure 2](../CommonFiles/ImpactEvaluation/figure/MVPEndlineEvaluationMap_Lancet2018Fig2.jpg){width="50%"}
::::
:::::::::::
...
::::::::::: {.columns}
:::: {.column width="40%"}
![@Mitchell2018, Figure 3A](../CommonFiles/ImpactEvaluation/figure/MVPEndlineEvaluationMap_Lancet2018Fig3A.jpg){width="50%"}
::::

:::: {.column width="60%"}
* All indices show positive impacts
* 最初から統御群を作っておけば良かったのに
::::
:::::::::::
...
治療群と統御群が似ていても、研究デザインの信頼性が低い場合や対象母集団が特殊である場合は、得られた知識が歪んでいる場合があります

1. Multiple testing ($p$ hacking)
1. Small sample bias
1. Publication bias
...
* $p=5\%$ $\Rightarrow$ 効果の平均値がゼロのとき、$n=100$回に$np$=5回は発生するかも、という「外れ」度<gray>If your threshold of extremeness is 5%, when the true mean impact is zero, you will have "extreme" ("statistically significant") impacts for $np=$5 times when you sample $n=100$ times </gray>
...
* 外れ値を得るまで何度も推計式定式化を変えると、望む結果が(理論的には)必ず得られる<gray>If you try different specifications as many times as necessary, you will get an estimate that you look for</gray>
   * 対策: Pre-analysis planを公開する、最低でも研究再現性のために推計のコードと結果を公開する<gray>publish pre-analysis plan, or, at least, estimation code and outputs for reproducibility</gray>
      * コードを公開して誰もが追試できれば、なぜこんな変数を右辺に使っているのか、なぜこんな定義にしているのか、のような細かな推計式定式化の選択について疑問点が自然と出てきて、外れ値を得るために何度も試行したかが分かります<gray>if you publish your estimation code, questions like, why does the author use this variable on RHS, why using such a definition, etc. will spawn out which may reveal if the author tried many specifications to get desired results</gray>
...
* 似た結果指標(例: 疲労と労働時間)への効果推計&larr;multiple testingを無意識にやっている<gray>similar outcome indicators (e.g., fatigue and work hours)&larr;unintentional multiple testing</gray>
   * 対策: 同じ結果指標グループの$p$値平均値family wise error rateを使う、同じ結果指標グループを指数化する<gray>Countermeasures: use the mean of $p$ values of similar outcomes (called "family wise error rate"), create a single index of similar outcomes using the normalised estimates and their standard errors</gray>
      * family wise error rateなどは似た推計値が幾つあっても$p$ hackingできない
      * 指数化=効果を(結果指標の標準偏差で割ることで)標準偏差単位にして(標準化standardisationという)、結果指標1を(結果指標1の)標準偏差単位でx1単位高める、結果指標2を(結果指標2の)標準偏差単位でx2単位高める、と足し算できるようにし、標準化された効果の平均値とその標準誤差を計算し、$p$ valueを得る

:::{style="font-size: 60%;line-height: 1.1;"}
<gray>

* You do not end up p-hacking even if you have many impact estimates so long as you use family wise error rate
* You divide the impacts with standard deviation of the outcome measure to get impacts in terms of standard deviation units (this is called standardisation). Then you average all the standardised impacts of all the impact estimates (of the same family) and compute its standard errors (formula of "standard error of the mean" is simple) to get $p$ values.
...
先入観・常識: そんなに大きいはずがない<gray>prejudice/common sense: cannot be that large</gray>
...
小標本=誤差が大きい=分散が大きい=分布の裾野が広い<gray>small sample=large errors=large variance=wider tails of distribution</gray>
...
* ずるではなく偶然大きな値になった可能性もある<gray>may be unintentional, may be by chance</gray>
   * プロならば、小標本バイアスに警戒すべき<gray>if you are a professional, got to be aware of the small sample bias</gray>
...
:::: {.column width="30%"}
:::{.fragment}
![](../CommonFiles/ImpactEvaluation/figure/heckman_returns.jpg){width="30%"}
:::
::::
:::::::::::
...
全ての推計方法への批判3: Publication bias

アフリカに関する経済学論文27,000本あまり(2000-2019)の地理分布

::::::::::: {.columns}
:::: {.column width="40%"}
![@Porteous2022, Figure 1](../CommonFiles/ImpactEvaluation/figure/Porteus2022Fig1.jpg){width="100%"}
::::

:::: {.column width="20%"}
![Source: freepik.com](../CommonFiles/ImpactEvaluation/figure/MapAfrica3.jpg){width="60%"}
::::
...
::::::::::: {.columns}
:::: {.column width="40%"}
![](../CommonFiles/ImpactEvaluation/figure/Porteus2022Tab1a.jpg){width="100%"}

![](../CommonFiles/ImpactEvaluation/figure/Porteus2022Tab1b.jpg){width="100%"}
...
信頼性の高い推計方法、$p$ hacking, small sample biasがなくても、publication biasがあるので、適用範囲や一般化を考える際に注意
