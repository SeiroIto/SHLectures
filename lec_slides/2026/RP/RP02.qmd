...
filters:
  ...
  - ../../../_extensions/dialoa/imagify/imagify.lua
imagify:
  header-includes: |
    \usetikzlibrary{calc}
...
```{r read homicide data, eval = F, results = "hide"}
...
::::{.column width="70%"}
```{r plot homicide in 2020, eval = F, width = 800}
