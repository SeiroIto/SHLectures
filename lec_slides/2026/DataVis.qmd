...
::::::::::{.columns}
::::{.column width="70%"}
![](../CommonFiles/DataVisualisation/SnowMap.jpg){width="90%"}
::::
...
grepout <- function(str, x)
  ...
  x[grep(str, x, perl = T)]
##### SMHGd <- qread("../CommonFiles/HK/SchoolingInfantMortalityGDP.qs")
#### qs_save(SMHGd, "../CommonFiles/HK/SchoolingInfantMortalityGDP.qs2")
SMHGd <- qs_read("../CommonFiles/HK/SchoolingInfantMortalityGDP.qs2")
...
ggsave(
  "../CommonFiles/DataVisualisation/SchoolEnrollmentInASinglePlot.jpg"
  , pS1,
  width = 8*2, height = 8*2, units = "cm", dpi = 300
 )
ggsave(
  "../CommonFiles/DataVisualisation/SchoolEnrollment.jpg"
  , pSby3,
  width = 8*2, height = 8*2, units = "cm", dpi = 300
 )
ggsave(
  "../CommonFiles/DataVisualisation/InfantMortality.jpg"
  , pM,
  width = 8*2, height = 8*2, units = "cm", dpi = 300
 )
ggsave(
  "../CommonFiles/DataVisualisation/InfantMortality19902020.jpg"
  , pM19902020,
  width = 8*2, height = 8*2, units = "cm", dpi = 300
 )
ggsave(
  "../CommonFiles/DataVisualisation/InfantMortality19902020Arrow.jpg"
  , pM19902020Arrow,
  width = 8*2, height = 8*2, units = "cm", dpi = 300
 )
ggsave(
  "../CommonFiles/DataVisualisation/InfantMortality19902020ArrowS.jpg"
  , pM19902020ArrowS,
  width = 8*2, height = 8*2, units = "cm", dpi = 300
 )
ggsave(
  "../CommonFiles/DataVisualisation/InfantMortalityPlus.jpg"
  , pMplus,
  width = 8*2, height = 8*2, units = "cm", dpi = 300
 )
cairo_pdf(
  "../CommonFiles/DataVisualisation/SchoolEnrollment.pdf"
...
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/InfantMortality.jpg){width="80%"}
...
g <- ggplot(data = adL, 
  ...
  theme_light()
ggsave(
  "../CommonFiles/DataVisualisation/Anscombe.jpg"
  , g,
  width = 8*2, height = 8*2, units = "cm", dpi = 300
 )
```
...
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/Anscombe.jpg){width="70%"}
...
ggsave(
  "../CommonFiles/DataVisualisation/TwoDistributions.jpg"
  , g,
  width = 8*2, height = 8*2, units = "cm", dpi = 300
 )
...
::::{.column width="50%"}
![](../CommonFiles/DataVisualisation/TwoDistributions.jpg){width="90%"}
::::
...
```{r gbd, fig.show = "hide"}
gbd <- fread("../CommonFiles/DataVisualisation/GBD2024.prn", nThread = 8)
...
for (gg in c("g1990hi", "g1990sa", "g1990ssa", "g2021hi", "g2021sa", "g2021ssa"))
{
  ...
  p <- ggplot(gtdata, aes(xmin = y0, ymin = x0, xmax = y1, ymax = x1)) + 
    ...
    theme_void()
  ggsave(
    paste0("../CommonFiles/DataVisualisation/", gg, ".jpg")
    , p,
    width = 8*2, height = 8*2, units = "cm", dpi = 300
   )
}
...
::::{.column width="50%"}
![](../CommonFiles/DataVisualisation/g2021hi.jpg){width="90%"}
::::
...
::::{.column width="33%"}
![High income, 2021](../CommonFiles/DataVisualisation/g2021hi.jpg){width="60%"}

![High income, 1990](../CommonFiles/DataVisualisation/g1990hi.jpg){width="60%"}
::::

::::{.column width="33%"}
![South Asia, 2021](../CommonFiles/DataVisualisation/g2021sa.jpg){width="60%"}

![South Asia, 1990](../CommonFiles/DataVisualisation/g1990sa.jpg){width="60%"}
::::

::::{.column width="33%"}
![Sub-Saharan Africa, 2021](../CommonFiles/DataVisualisation/g2021ssa.jpg){width="60%"}

![Sub-Saharan Africa, 1990](../CommonFiles/DataVisualisation/g1990ssa.jpg){width="60%"}
::::
::::::::::
...
::::::::::{.columns}
::::{.column width="35%"}
![](../CommonFiles/DataVisualisation/Curry.jpg){}
::::

::::{.column width="35%"}
![](../CommonFiles/DataVisualisation/Steph.jpg){}
::::
...
<lord-icon
    ...
    trigger="hover"
    style="width:30px;height:30px">
</lord-icon> <span style="text-align: left; font-size: 20px">[Kieth Allen](https://commons.wikimedia.org/wiki/File:Stephen_Curry_(24180454343).jpg)</span><span style="text-align: left; font-size: 10px">![](../CommonFiles/DataVisualisation/cc-by-sa.jpg)</span><div style="text-align: right; font-size: 12px"><a href="https://lordicon.com/">Animated icons by Lordicon.com</a></div>
...
::::::::::{.columns}
::::{.column width="15%"}
![](../CommonFiles/DataVisualisation/Tufte2001Cover.jpg){width="70%"}
::::
::::{.column width="15%"}
![](../CommonFiles/DataVisualisation/Tufte1997Cover.jpg){width="70%"}
::::
::::{.column width="15%"}
![](../CommonFiles/DataVisualisation/Tufte2006Cover.jpg){width="100%"}
::::
...
::::::::::{.columns}
::::{.column width="15%"}
![](../CommonFiles/DataVisualisation/Cleveland1985Cover.jpg){width="70%"}
::::
::::{.column width="15%"}
![](../CommonFiles/DataVisualisation/Cleveland1993Cover.jpg){width="70%"}
::::
::::{.column width="15%"}
::::
...
::::::::::{.columns}
::::{.column width="15%"}
![](../CommonFiles/DataVisualisation/WilkeBookCover.png){width="70%"}
::::
::::{.column width="15%"}
::::
::::{.column width="15%"}
...
::::::::::{.columns}
::::{.column width="15%"}
![](../CommonFiles/DataVisualisation/HealyBookCover.jpg){width="70%"}
::::
::::{.column width="15%"}
::::
::::{.column width="15%"}
...
::::::::::{.columns}
::::{.column width="15%"}
![](../CommonFiles/DataVisualisation/RSS_logo_colour.png){width="100%"}
::::
::::{.column width="30%"}
![](../CommonFiles/DataVisualisation/RSS_DataVisTitle.png){width="100%"}
::::
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/ChallengerExplosion.jpg){width="100%"}
::::
::::{.column width="40%"}
* 乗員7名全員死亡
* 原因:
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/ShuttleRockets2.jpg){width="80%"}

![](../CommonFiles/DataVisualisation/ChallengerLiftOff.jpg){width="80%"}
::::
::::{.column width="40%"}
![](../CommonFiles/DataVisualisation/BoosterSegment.jpg)
::::
::::::::::
...
::: {style="text-align: center;"}
![](../CommonFiles/DataVisualisation/ChallengerCrew.jpg)
:::
...
![](../CommonFiles/DataVisualisation/TufteCorrectedDisplayOfShuttle.png)
...
![](../CommonFiles/DataVisualisation/ShuttleRockets1.png)
...
![](../CommonFiles/DataVisualisation/IcedRubberExperiment.jpg){width="70%"}
...
![](../CommonFiles/DataVisualisation/ScottLieberman_ShuttleColumbiaAccident.jpg){width="90%"}
:::
::::
::::::::::
...
::::{.column width="40%"}
:::{.fragment}
![](../CommonFiles/DataVisualisation/ColumbiaCorrectFigure.png)
:::
::::
::::::::::
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/Wilke/Barplots.jpg){width="100%"}
...
::::::::::{.columns}
::::{.column width="40%"}
![](../CommonFiles/DataVisualisation/Wilke/Piechart.jpg){width="100%"}

<Red>円グラフを使ってはいけない</Red>

![](../CommonFiles/DataVisualisation/experts.png){width="10%"}[専門家の意見](../CommonFiles/DataVisualisation/piechartisunchi.mp4)
::::
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/Wilke/WrongAndCorrectBarplots.jpg)
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/Wilke/Dotplot.jpg)
...
:::{.fragment}
![](../CommonFiles/DataVisualisation/Wilke/DotplotTransposed.jpg){width="50%"}
:::
::::
::::::::::
...
::::::::::{.columns}
::::{.column width="40%"}
![](../CommonFiles/DataVisualisation/Wilke/HeatmapFemaleLifeExpectancy.jpg){width="70%"}
...
::::::::::{.columns}
::::{.column width="70%"}
![](../CommonFiles/DataVisualisation/Wilke/HeatmapNormalAndExcessFemaleLifeExpectancySelected.jpg)
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/Wilke/ColourDeficiencyLinePoint.jpg)
...
::::::::::{.columns}
::::{.column width="50%"}
![](../CommonFiles/DataVisualisation/Wilke/GroupedBarplots.jpg){width="80%"}
...
::::::::::{.columns}
::::{.column width="50%"}
![](../CommonFiles/DataVisualisation/Wilke/CasesByGender.jpg){width="70%"}
::::
...
::::::::::{.columns}
::::{.column width="70%"}
![](../CommonFiles/DataVisualisation/Wilke/CasesByAgeGroup.jpg){width="70%"}
...
::::::::::{.columns}
::::{.column width="80%"}
![](../CommonFiles/DataVisualisation/Wilke/WilkeScatter.jpg)
...
::::::::::{.columns}
::::{.column width="65%"}
![](../CommonFiles/DataVisualisation/Wilke/WilkeChoropleth.jpg)
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/InfantMortality19902020Arrow.jpg){width="90%"}
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/InfantMortality19902020.jpg){width="90%"}
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/InfantMortality19902020ArrowS.jpg){width="90%"}
...
::::::::::{.columns}
::::{.column width="60%"}
![](../CommonFiles/DataVisualisation/SchoolEnrollmentInASinglePlot.jpg){width="90%"}
...
g <- plot_grid(gg[[1]], gg[[2]], rel_widths = c(1.5, 2),
   labels = c('縦方向', '横方向'))
ggsave(
   paste0("../CommonFiles/DataVisualisation/LayoutExample1.jpg")
...
::::::::::{.columns}
::::{.column width="75%"}
![](../CommonFiles/DataVisualisation/LayoutExample1.jpg){width="100%"}
...
g <- plot_grid(gg[[1]], gg[[2]], rel_widths = c(2, 1.5), 
   labels = c('縦方向', '横方向'))
ggsave(
   paste0("../CommonFiles/DataVisualisation/LayoutExample2.jpg")
  , g, width = 14*2, height = 8*2, units = "cm",
  dpi = 300
)
```
...
::::{.column width="75%"}
![](../CommonFiles/DataVisualisation/LayoutExample2.jpg){width="100%"}
