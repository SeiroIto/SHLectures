...
1. 講義で示したように、仮定無しには効果推計はできません。また、実験もできないとしましょう。このとき、同意なきTOBが成立した2期後の効果を測るためには、どのような仮定を置いて何と比較すべきですか。
   * TOBがあった企業を治療群とします。TOBがなかった企業のうち、TOB成立前年の営業利益率が最も近い企業(以下、「統御群」と呼ぶ)を選びます。統御群の営業利益率の平均値をCFとして比較します。さらに、DID推計をするために、治療群と統御群の営業利益率変化を比較します。
...
4. 記者の立場になり、「2.4ポイント低下」を効果として解釈・正当化できるための仮定を示してください。
   ...
   * 効果として解釈するためには、TOB不成立のときにTOB成立年から3-4年間は利益率が変わらない、という仮定が必要である。これは現実妥当性が低い。
