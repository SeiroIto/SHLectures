...
![b. Photo by Warren K. Leffler](DC1970.jpg){width="50%"}

U.S. News & World Report Magazine/Library of Congress, Washington, D.C. (digital. id. ppmsca 03425)
:::
...
1. イマムがテキスト・メッセージを送ることの効果を計測するには、どのような実験が必要でしょうか。
